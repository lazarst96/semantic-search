...
# QA_MODEL_URL = 'http://localhost:8501/v1/models/qa:predict'

RESOURCE_COLLECTION = "answers"
QUESTIONS_COLLECTION = "questions"


def get_embedding(client: httpx.Client, contexts: List[str]) -> List[List[float]]:
...
def insert_responses_batch(client: MongoClient, collection_name: str, batch_data: List[str]) -> None:
    records = []
    embeddings = get_embedding(http_client, batch_data)
